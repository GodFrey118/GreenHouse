$(function(){
    ...
    $('*[ectype="goods_selector"]').click(function(){
        var id = $(this).attr('gs_id');
        var name = $(this).attr('gs_name');
        var callback = $(this).attr('gs_callback');
        var type = $(this).attr('gs_type');
        ...
        var title = $(this).attr('gs_title') ? $(this).attr('gs_title') : '';
        var width = $(this).attr('gs_width');
        var active = $(this).attr('gs_active');
        ajax_form(id, title, SITE_URL + '/index.php?app=gselector&act=' + type + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&active='+active+'&callback=' + callback, width);
        return false;
    });
    $('*[ectype="certification_goods_selector"]').click(function(){
        var id = $(this).attr('gs_id');
        var name = $(this).attr('gs_name');
        var callback = $(this).attr('gs_callback');
        var type = $(this).attr('gs_type');
        ...
        var title = $(this).attr('gs_title') ? $(this).attr('gs_title') : '';
        var width = $(this).attr('gs_width');
        var if_certification = $(this).attr('if_certification');
        ajax_form(id, title, SITE_URL + '/index.php?app=gselector&act=' + type + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&if_certification='+if_certification+'&callback=' + callback, width);
        return false;
    });
    
    $('*[ectype="region_selector"]').click(function(){
		var id = $(this).attr('gs_id');										
        var callback = $(this).attr('gs_callback');
		var act = $(this).attr('gs_act');
		var type = $(this).attr('gs_type');
        var title = $(this).attr('gs_title') ? $(this).attr('title') : '';
        var width = $(this).attr('gs_width');
        ajax_form(id, title, '/index.php?app=my_shipping&act=' + act + '&dialog=1&title=' + title + '&type=' + type+ '&select_hide=' + id + '&callback=' + callback, width);
        return false;
    });
