...
<body>
	<div id="loginDiv">
		<form id="loginForm" action="adm/AdmLogin" method="post">
			<p><label>${errorMsg }&nbsp;</label></p><c:remove var="errorMsg" scope="session"/>
			<p><input name="adm_name" placeholder="请输入用户名" required="required"/></p>
			<p><input type="password" name="adm_pwd" placeholder="请输入密码"  required="required"/></p>
