...
<div class="index_tbar ">
      <div class=" grid ">
           ...
           <div class="fr">
				...
				<c:otherwise>
				<span class="fl name sn-login-info" style='color:green;'>欢迎  ${loginUser } 使用本网站 &nbsp &nbsp &nbsp &nbsp<a href="page/perinfo.jsp" class="sn-login">个人信息</a> 
                 ...
                 <li class="line">|</li>
	                    <li class="col-con">
	                      <div class="ui-dropdown login-menu">     
                              <a href="#" class="ui-dropdown-hd">我的订单 <b></b></a> 
