/* spec对象 */
function spec(id, spec1, spec2, spec3, price, wholesale_price , stock)
{
    this.id    = id;
    this.spec1 = spec1;
    this.spec2 = spec2;
...
function goodsAll_spec(){
	this.spec1 = new Array();
	this.spec2 = new Array();
	this.spec3 = new Array();
	this.spec1.spec1 = new Array();
	this.spec1.spec2 = new Array();
	this.spec1.spec3 = new Array();
	this.spec2.spec1 = new Array();
	this.spec2.spec2 = new Array();
	this.spec2.spec3 = new Array();
	this.spec3.spec1 = new Array();
	this.spec3.spec2 = new Array();
	this.spec3.spec3 = new Array();
}
//取数组去重
...
/* goodsspec对象 */
function goodsspecs(specs, specQty, defSpec)
{
    this.specs = specs;
...
function selectSpec(num, liObj)
{
    ...
    else
    {
        ...
        {
            $("[ectype='current_spec']").html(spec.spec1 + ' ' + spec.spec2);
			$("[ectype='wholesale_price']").html(price_format(spec.wholesale_price));
...
$(function(){
  // goodsspec.init();
    ...
    // 图片替换效果
    $('.ware_boxx li').mouseover(function(){
        $('.ware_boxx li').attr('id','');
        $(this).attr('id','ware_pic_hover');
